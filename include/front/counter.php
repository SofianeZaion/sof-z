<div>
    ...
    <?php if ($idUtilisateur !== 0): ?>
        <form method="post" class="counter d-flex" action="ajouter_panierFront.php">
            ...
            if ($qty != 0) {
                ?>
                <button formaction="supprimer_panierFront.php" class="btn btn-sm btn-danger mx-1 " type="submit"
                        name="supprimer">
    ...
    <?php else: ?>
        <div class="alert alert-warning" role="alert">
            Vous devez être connecté pour acheter ce produit <strong><a href="ConnexionFront.php">Connexion</a></strong>
        </div>
    <?php endif; ?>
</div>