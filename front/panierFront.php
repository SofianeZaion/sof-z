...
<body style="background-color:cadetblue">
    ...
    <div class="container py-2">
        ...
        if (isset($_POST['vider'])) {
            ...
            header('location: panierFront.php');
        }
        ...
        if (isset($_POST['valider'])) {
            ...
            if ($inserted) {
                $_SESSION['panier'][$idUtilisateur] = [];
                header('location: page_paiementFront.php?total=' . $total);
            } else {
                ?>
                ...
                if (empty($panier)) {
                    if (!isset($_GET['success'])) {
                        ...
                        <div class="alert alert-warning" role="alert">
                            ...
                            Commençez vos achats <a class="btn btn-success btn-sm" href="pageproduitFront.php">Acheter des
                                produits</a>
                        </div>
                        <?php
                    }
